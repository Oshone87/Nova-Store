  ...
  return (
    <section className='max_padd_container pt-28'>
        <table className='w-full mx-auto'>
            <thead>
                <tr className='bg-slate-900/10 regular-18 sm:regular-22 text-start py-15'>
            ...
            <tbody>
                {all_products.map((e) =>{
                    if(cartItems[e.id] > 0 ){
                        return <tr key={e.id} className='border-b border-slate-900/20 p-6
                        medium-14 text-center'>
                            <td className='flexCenter'><img src={e.image} alt="prdctimg" height={43} width={43} className='
                            ...
                            <td>
                                <div className='bold-22 flexCenter'><TbTrash onClick={()=> removeFromCart(e.id)} /></div>
                            </td>
                        </tr>
                    }
                    return null;
