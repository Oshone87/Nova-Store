  ...
  return (
    <section className='max_padd_container py-12 xl:py-28 bg-white'>
        ...
        w-full max-w-[666px]'>
            ...
            <div className='flexBetween rounded-full ring-1 ring-slate-900/5 hover:ring-slate-900/15
            bg-primary w-full max-w-[588px]'>
                <input type='email' placeholder='Enter your email' className='w-full bg-transparent ml-7 border-none
